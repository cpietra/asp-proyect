<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SSS.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="TextUserName" CssClass="col-md-2 control-label">Nombre de Usuario</asp:Label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                   <asp:Label runat="server" AssociatedControlID="DropDownList1" CssClass="col-md-2 control-label">Rol del Usuario</asp:Label>
        <div class="col-md-10">   
