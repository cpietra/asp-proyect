<%@ Page Title="" Language="C#" MasterPageFile="~/system/mastersys.master" AutoEventWireup="true" CodeBehind="sys_repo_cirugias.aspx.cs" Inherits="SSS.system.sys_repo_ciugias" EnableEventValidation="false" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajk" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <link href="../Content/Popup.css" rel="stylesheet" />
    <asp:Panel ID="Panel1" runat="server" Height="844px" Style="margin-left: 8px; margin-bottom: 36px;" Width="1800px" HorizontalAlign="Left" Direction="LeftToRight">
        <asp:Panel ID="Panel3" runat="server" Height="86px">
            Desde Fecha de Cirugia :<asp:TextBox ID="txtFDesde" runat="server" ></asp:TextBox>
            <ajk:CalendarExtender ID="cfdesde" runat="server" TargetControlID="txtFDesde" Format="dd/MM/yyyy" />
            <ajk:MaskedEditExtender ID="mskdesde" TargetControlID="txtFDesde" runat="server" Mask="99/99/9999" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" MaskType="Date" ErrorTooltipEnabled="True" />
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtFDesde" Display="Dynamic" ErrorMessage="Formato Invalido" ForeColor="#CC0000" ValidationExpression="^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$"></asp:RegularExpressionValidator>
            &nbsp;Cirujano:<asp:TextBox ID="txtcirujanob" runat="server"></asp:TextBox>
            &nbsp;<br />
            Hasta Fecha de Cirugia :<asp:TextBox ID="txtFHasta" runat="server" ></asp:TextBox>
            <ajk:CalendarExtender ID="chasta" runat="server" TargetControlID="txtFHasta" Format="dd/MM/yyyy" />
            <ajk:MaskedEditExtender ID="mskhasta" TargetControlID="txtFHasta" runat="server" Mask="99/99/9999" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError" MaskType="Date" ErrorTooltipEnabled="True" />
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtFHasta" Display="Dynamic" ErrorMessage="Formato Invalido" ForeColor="#CC0000" ValidationExpression="^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$"></asp:RegularExpressionValidator>
            &nbsp;&nbsp; Cobertura:
            <asp:DropDownList ID="DropDownList2" AppendDataBoundItems="true" runat="server">
                <asp:ListItem Text="Cobertura" Value="0" />
            </asp:DropDownList>
            <br />
            <asp:Button ID="Button1" runat="server" Text="Buscar" OnClick="Button1_Click" />
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Limpiar" />
            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Imprimir" />
            <asp:Button ID="Button4" runat="server" Text="Editar" Enabled="False" />
        </asp:Panel>
        <br />
    ...
    <ajk:ModalPopupExtender ID="mp1" runat="server" PopupControlID="pnlPopup" TargetControlID="Button4" BackgroundCssClass="Background"/>

     <asp:Panel ID="pnlPopup" runat="server" CssClass="Popup" Style="display: none" ScrollBars="None">
        Fecha :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txtfechaint" Display="Dynamic" ErrorMessage="Formato Invalido" ForeColor="#CC0000" ValidationExpression="^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$"></asp:RegularExpressionValidator>
        &nbsp;<br />
        ...
        Obsercacion:<asp:TextBox ID="txtobservacion" runat="server" Width="412px"></asp:TextBox>
         <br />
        <asp:Button ID="Button5" runat="server" Text="Actualizar" AutoPostBack="True" OnClick="Button5_Click" />
        <asp:Button ID="Button6" runat="server" Text="Cancela" OnClick="Button6_Click" />
        </asp:Panel>
</asp:Content>
